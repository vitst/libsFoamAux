...
template<class Type>
void Foam::functionObjects::fieldProcTime::output
(
...
template<class Type>
void Foam::functionObjects::fieldProcTime::calcProcTimeFieldType
(
...
)
{
    ...
    labelPair minMaxIds = findProcTime(field);
...
template<class Type>
void Foam::functionObjects::fieldProcTime::calcProcTimeFields
(
    const word& fieldName,
    const modeType& mode
)
{
    ...
    if (obr_.foundObject<fieldType>(fieldName))
    {
        ...
        switch (mode)
        {
            ...
            case mdCmpt:
            {
                calcProcTimeFieldType(field, fieldName);
                break;
            }
            default:
            {
