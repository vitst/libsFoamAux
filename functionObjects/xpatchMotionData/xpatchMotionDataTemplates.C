...
template<class Type>
bool Foam::functionObjects::xpatchMotionData::foundObject
(
    const word& name,
    const bool verbose
) const
...
template<class Type>
void Foam::functionObjects::xpatchMotionData::getBoundaryValues
(
...
)
{
    ...
    if (obr_.foundObject<fieldType>(fieldName))
    {
        ...
        //const Field<Type>& CCb = Foam::mag(field.boundaryField()[patchID];
  
        values_ = Foam::mag( field.boundaryField()[patchID] );
    }
}
